...
/* 37F3C 8004773C 52006018 */  blez       $v1, VM_ALOC1_OBJ_178
...
/* 37F60 80047760 44004014 */  bnez       $v0, VM_ALOC1_OBJ_164
...
/* 37FA0 800477A0 221E0108 */  j          VM_ALOC1_OBJ_178
...
/* 37FFC 800477FC 1D1E0108 */  j          VM_ALOC1_OBJ_164
/* 38000 80047800 01000A24 */   addiu     $t2, $zero, 0x1
.L80047804:
/* 38004 80047804 1B00C514 */  bne        $a2, $a1, VM_ALOC1_OBJ_164
...
/* 38038 80047838 1C1E0108 */  j          VM_ALOC1_OBJ_160
/* 3803C 8004783C 2160C000 */   addu      $t4, $a2, $zero
.L80047840:
/* 38040 80047840 0C00A414 */  bne        $a1, $a0, VM_ALOC1_OBJ_164
...
.size VM_ALOC1_OBJ_160, . - VM_ALOC1_OBJ_160

glabel VM_ALOC1_OBJ_178
/* 38088 80047888 FF006331 */  andi       $v1, $t3, 0xFF
/* 3808C 8004788C 63000224 */  addiu      $v0, $zero, 0x63
/* 38090 80047890 05006214 */  bne        $v1, $v0, VM_ALOC1_OBJ_198
/* 38094 80047894 FF004231 */   andi      $v0, $t2, 0xFF
/* 38098 80047898 03004014 */  bnez       $v0, VM_ALOC1_OBJ_198
...
.size VM_ALOC1_OBJ_178, . - VM_ALOC1_OBJ_178

glabel VM_ALOC1_OBJ_198
...
/* 380E4 800478E4 0B004014 */  bnez       $v0, VM_ALOC1_OBJ_204
...
.size VM_ALOC1_OBJ_198, . - VM_ALOC1_OBJ_198

glabel VM_ALOC1_OBJ_204
...
.size VM_ALOC1_OBJ_204, . - VM_ALOC1_OBJ_204
...
/* 38234 80047A34 9A1E0108 */  j          VM_ALOC2_OBJ_E8
